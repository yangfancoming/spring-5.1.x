 ...
 *
 * xmlBeanDefinitionReaderThis class is a concrete expression of the "Open Session in View" pattern, which
 ...
 *
 * xmlBeanDefinitionReaderThis interceptor makes Hibernate Sessions available via the current thread,
 ...
 *
 * xmlBeanDefinitionReaderIn contrast to {@link OpenSessionInViewFilter}, this interceptor is configured
 * in a Spring application context and can thus take advantage of bean wiring.
 *
 * xmlBeanDefinitionReader<b>WARNING:</b> Applying this interceptor to existing logic can cause issues
...
public class OpenSessionInViewInterceptor implements AsyncWebRequestInterceptor {
	 ...
	 * already intercepted.
	 * xmlBeanDefinitionReaderThe default implementation takes the {@code toString()} representation
