 ...
 *
 * xmlBeanDefinitionReaderDefines {@code HibernateTemplate}'s data access methods that mirror various
 ...
 *
 * xmlBeanDefinitionReader<b>A deprecation note:</b> While {@link HibernateTemplate} and this operations
 ...
 *
 * xmlBeanDefinitionReader<b>A Hibernate compatibility note:</b> {@link HibernateTemplate} and the
...
public interface HibernateOperations {
	 ...
	 * xmlBeanDefinitionReaderApplication exceptions thrown by the action object get propagated
	 ...
	 * xmlBeanDefinitionReaderNote: Callback code is not supposed to handle transactions itself!
	 ...
	 * xmlBeanDefinitionReaderThis method is a thin wrapper around
	 ...
	 * Return the persistent instance of the given entity class
	 * with the given identifier, or {@code null} if not found.
	 * xmlBeanDefinitionReaderObtains the specified lock mode if the instance exists.
	 * xmlBeanDefinitionReaderThis method is a thin wrapper around
	 ...
	 * Update the given persistent instance,
	 * associating it with the current Hibernate {@link org.hibernate.Session}.
	 * xmlBeanDefinitionReaderObtains the specified lock mode if the instance exists, implicitly
	 * checking whether the corresponding database entry still exists.
	 * @param entity the persistent instance to update
	 * @param lockMode the lock mode to obtain
	 * @throws org.springframework.orm.ObjectOptimisticLockingFailureException if not found
	 ...
	 * xmlBeanDefinitionReaderSimilar to {@code save}, associating the given object
	 ...
	 * xmlBeanDefinitionReaderSimilar to {@code saveOrUpdate}, but never associates the given
	 * object with the current Hibernate Session. In case of a new entity,
	 * the state will be copied over as well.
	 * xmlBeanDefinitionReaderNote that {@code merge} will <i>not</i> update the identifiers
	 ...
	 * xmlBeanDefinitionReaderThis can be combined with any of the find methods to delete by query
	 ...
	 * xmlBeanDefinitionReaderOnly invoke this for selective eager flushing, for example when
	 ...
	 * in the query string.
	 * xmlBeanDefinitionReaderA named query is defined in a Hibernate mapping file.
	 ...
	 * xmlBeanDefinitionReaderReturns the results as an {@link Iterator}. Entities returned are
