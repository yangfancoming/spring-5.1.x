 ...
 *
 * xmlBeanDefinitionReaderRequires a {@link SessionFactory} to be set, providing a
 ...
 *
 * xmlBeanDefinitionReaderThis class will create its own HibernateTemplate instance if a SessionFactory
 ...
 *
 * xmlBeanDefinitionReader<b>NOTE: Hibernate access code can also be coded in plain Hibernate style.
...
public abstract class HibernateDaoSupport extends DaoSupport {
	 ...
	 * xmlBeanDefinitionReaderCan be overridden in subclasses to provide a HibernateTemplate instance
	 ...
	 * xmlBeanDefinitionReader<b>Note: The returned HibernateTemplate is a shared instance.</b>
