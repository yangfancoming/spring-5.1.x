 ...
 *
 * xmlBeanDefinitionReaderContains an implementation of Spring's transaction SPI for local Hibernate transactions.
 ...
 *
 * xmlBeanDefinitionReader<b>This package supports Hibernate 5.x only.</b>
 */
@NonNullApi
@NonNullFields
