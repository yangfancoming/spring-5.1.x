 ...
 *
 * xmlBeanDefinitionReaderThe central method is {@code execute}, supporting Hibernate access code
 ...
 *
 * xmlBeanDefinitionReaderCan be used within a service implementation via direct instantiation
 * with a SessionFactory reference, or get prepared in an application context
 * and given to services as bean reference. Note: The SessionFactory should
 * always be configured as bean in the application context, in the first case
 * given to the service directly, in the second case to the prepared template.
 *
 * xmlBeanDefinitionReader<b>NOTE: Hibernate access code can also be coded against the native Hibernate
...
public class HibernateTemplate implements HibernateOperations, InitializingBean {
	 ...
	 * xmlBeanDefinitionReaderEach of those filters will be enabled at the beginning of each
	 ...
	 * xmlBeanDefinitionReaderDefault is "false": a Session proxy will be returned, suppressing
	 ...
	 * xmlBeanDefinitionReaderDefault is "true", for fail-fast behavior when attempting write operations
	 ...
	 * xmlBeanDefinitionReaderIf this is "true", all Query and Criteria objects created by
	 * this template will be marked as cacheable (including all
	 * queries through find methods).
	 * xmlBeanDefinitionReaderTo specify the query region to be used for queries cached
	 ...
	 * xmlBeanDefinitionReaderIf this is specified, it will be applied to all Query and Criteria objects
	 * created by this template (including all queries through find methods).
	 * xmlBeanDefinitionReaderThe cache region will not take effect unless queries created by this
	 ...
	 * xmlBeanDefinitionReaderDefault is 0, indicating to use the JDBC driver's default.
	 */
	 ...
	 * native {@link Session}.
	 * xmlBeanDefinitionReaderThis execute variant overrides the template-wide
	 ...
	 * xmlBeanDefinitionReaderDefault implementation throws an InvalidDataAccessApiUsageException in
