 ...
 *
 * xmlBeanDefinitionReaderThis is designed for programmatic use, e.g. in {@code @Bean} factory methods;
 ...
 *
 * xmlBeanDefinitionReaderThis builder supports Hibernate 5.3 {@code BeanContainer} integration,
...
public class LocalSessionFactoryBuilder extends Configuration {
	 ...
	 * xmlBeanDefinitionReaderA passed-in Spring {@link JtaTransactionManager} needs to contain a JTA
	 * {@link TransactionManager} reference to be usable here, except for the WebSphere
	 * case where we'll automatically set {@code WebSphereExtendedJtaPlatform} accordingly.
	 * xmlBeanDefinitionReaderNote: If this is set, the Hibernate settings should not contain a JTA platform
	 ...
	 * xmlBeanDefinitionReaderNote: Bean container integration requires Hibernate 5.3 or higher.
