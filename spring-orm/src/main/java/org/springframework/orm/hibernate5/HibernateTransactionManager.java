 ...
 *
 * xmlBeanDefinitionReaderSupports custom isolation levels, and timeouts that get applied as
 * Hibernate transaction timeouts.
 *
 * xmlBeanDefinitionReaderThis transaction manager is appropriate for applications that use a single
 ...
 *
 * xmlBeanDefinitionReaderNote: To be able to register a DataSource's Connection for plain JDBC code,
 * this instance needs to be aware of the DataSource ({@link #setDataSource}).
 * The given DataSource should obviously match the one used by the given SessionFactory.
 *
 * xmlBeanDefinitionReaderJTA (usually through {@link org.springframework.transaction.jta.JtaTransactionManager})
 ...
 *
 * xmlBeanDefinitionReaderThis transaction manager supports nested transactions via JDBC 3.0 Savepoints.
...
public class HibernateTransactionManager extends AbstractPlatformTransactionManager
	 ...
	 * xmlBeanDefinitionReaderIf the SessionFactory was configured with LocalDataSourceConnectionProvider,
	 * i.e. by Spring's LocalSessionFactoryBean with a specified "dataSource",
	 * the DataSource will be auto-detected: You can still explicitly specify the
	 * DataSource, but you don't need to in this case.
	 * xmlBeanDefinitionReaderA transactional JDBC Connection for this DataSource will be provided to
	 * application code accessing this DataSource directly via DataSourceUtils
	 * or JdbcTemplate. The Connection will be taken from the Hibernate Session.
	 * xmlBeanDefinitionReaderThe DataSource specified here should be the target DataSource to manage
	 * transactions for, not a TransactionAwareDataSourceProxy. Only data access
	 * code may work with TransactionAwareDataSourceProxy, while the transaction
	 * manager needs to work on the underlying target DataSource. If there's
	 * nevertheless a TransactionAwareDataSourceProxy passed in, it will be
	 * unwrapped to extract its target DataSource.
	 * xmlBeanDefinitionReader<b>NOTE: For scenarios with many transactions that just read data from
	 ...
	 * xmlBeanDefinitionReaderCan be turned off to deliberately ignore an available DataSource, in order
	 ...
	 * JDBC Connection.
	 * xmlBeanDefinitionReaderDefault is "true". If you turn this flag off, the transaction manager
	 ...
	 * xmlBeanDefinitionReaderDefault is "false". Turning this flag on enforces over-commit holdability on the
	 ...
	 * check preceding it).
	 * xmlBeanDefinitionReaderDefault is "false", i.e. using a Spring-managed Session: taking the current
	 ...
	 * xmlBeanDefinitionReaderSwitch this flag to "true" in order to enforce use of a Hibernate-managed Session.
	 ...
	 * xmlBeanDefinitionReaderThis mode will typically be used in combination with a custom Hibernate
	 ...
	 * xmlBeanDefinitionReaderRequires the bean factory to be known, to be able to resolve the bean
	 * name to an interceptor instance on session creation. Typically used for
	 * prototype interceptors, i.e. a new interceptor instance per session.
	 * xmlBeanDefinitionReaderCan also be used for shared interceptor instances, but it is recommended
	 ...
	 * Will get applied to any new Session created by this transaction manager.
	 * xmlBeanDefinitionReaderSuch an interceptor can either be set at the SessionFactory level,
	 ...
	 * xmlBeanDefinitionReaderThe default implementation simply calls {@link Session#disconnect()}.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation checks the Session's connection release mode
	 * to be "on_close".
