 ...
 *
 * xmlBeanDefinitionReaderThis filter makes Hibernate Sessions available via the current thread, which
 ...
 *
 * xmlBeanDefinitionReader<b>NOTE</b>: This filter will by default <i>not</i> flush the Hibernate Session,
 ...
 *
 * xmlBeanDefinitionReader<b>WARNING:</b> Applying this filter to existing logic can cause issues that
 ...
 *
 * xmlBeanDefinitionReaderLooks up the SessionFactory in Spring's root web application context.
...
public class OpenSessionInViewFilter extends OncePerRequestFilter {
	 ...
	 * xmlBeanDefinitionReaderThe default implementation delegates to the {@link #lookupSessionFactory()}
	...
	/**
	 * Look up the SessionFactory that this filter should use.
	 * xmlBeanDefinitionReaderThe default implementation looks for a bean with the specified name
	 ...
	 * xmlBeanDefinitionReaderThe default implementation delegates to the {@link SessionFactory#openSession}
