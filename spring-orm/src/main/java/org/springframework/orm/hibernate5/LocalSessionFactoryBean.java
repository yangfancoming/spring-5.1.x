 ...
 *
 * xmlBeanDefinitionReaderCompatible with Hibernate 5.0/5.1 as well as 5.2/5.3, as of Spring 5.1.
...
public class LocalSessionFactoryBean extends HibernateExceptionTranslator
	 ...
	 * xmlBeanDefinitionReaderIf this is set, the Hibernate settings should not define
	 ...
	 * xmlBeanDefinitionReaderNote: Can be omitted when all necessary properties and mapping
	 ...
	 * xmlBeanDefinitionReaderCan be used to add to mappings from a Hibernate XML config file,
	 ...
	 * xmlBeanDefinitionReaderNote: If this is set, the Hibernate settings should not define a
	 ...
	 * xmlBeanDefinitionReaderNote: Do not specify a transaction provider here when using
	 ...
	 * xmlBeanDefinitionReaderDefault is to search all specified packages for classes annotated with
	 ...
	 * xmlBeanDefinitionReader{@code SessionFactory} initialization will then switch into background
	 ...
	 * xmlBeanDefinitionReaderThis will only be applied for an internally built {@link MetadataSources}
	 ...
	 * xmlBeanDefinitionReaderCan also be externally called to initialize and pre-populate a {@link MetadataSources}
	 ...
	 * xmlBeanDefinitionReaderThe default implementation invokes LocalSessionFactoryBuilder's buildSessionFactory.
