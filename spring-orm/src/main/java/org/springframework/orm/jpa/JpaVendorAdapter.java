...
public interface JpaVendorAdapter {
	 ...
	 * xmlBeanDefinitionReaderNote that there might be further JPA properties defined on the
	 * EntityManagerFactory bean, which might potentially override individual
	 * JPA property values specified here.
	 * xmlBeanDefinitionReaderThis implementation delegates to {@link #getJpaPropertyMap()} for
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> This variant will only be invoked in case of Java EE style
	 ...
	 * xmlBeanDefinitionReaderIf the provider does not offer any EntityManagerFactory extensions,
	 ...
	 * xmlBeanDefinitionReaderIf the provider does not offer any EntityManager extensions,
	 * the adapter should simply return the standard
	 ...
	 * before active use.
	 * xmlBeanDefinitionReaderThis can be used for triggering vendor-specific initialization processes.
