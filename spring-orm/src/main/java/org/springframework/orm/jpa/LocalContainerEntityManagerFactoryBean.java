 ...
 * configuration!
 *
 * xmlBeanDefinitionReaderAs with {@link LocalEntityManagerFactoryBean}, configuration settings
 ...
 *
 * xmlBeanDefinitionReaderInternally, this FactoryBean parses the {@code persistence.xml} file
 ...
 *
 * xmlBeanDefinitionReaderThe exposed EntityManagerFactory object will implement all the interfaces of
...
public class LocalContainerEntityManagerFactoryBean extends AbstractEntityManagerFactoryBean
	 ...
	 * xmlBeanDefinitionReaderThe default is to rely on the local settings specified on this FactoryBean,
	 * such as "persistenceXmlLocation", "dataSource" and "loadTimeWeaver".
	 * xmlBeanDefinitionReaderFor reuse of existing persistence unit configuration or more advanced forms
	 ...
	 * xmlBeanDefinitionReader<b>NOTE: Only applied if no external PersistenceUnitManager specified.</b>
	 ...
	 * DataSource instead.
	 * xmlBeanDefinitionReaderIn JPA speak, a DataSource passed in here will be used as "nonJtaDataSource"
	 ...
	 * JDBC configuration in {@code persistence.xml}, passing in a Spring-managed
	 * DataSource instead.
	 * xmlBeanDefinitionReaderIn JPA speak, a DataSource passed in here will be used as "jtaDataSource"
	 * on the PersistenceUnitInfo passed to the PersistenceProvider, as well as
	 * overriding data source configuration in {@code persistence.xml} (if any).
	 * xmlBeanDefinitionReader<b>NOTE: Only applied if no external PersistenceUnitManager specified.</b>
	 ...
	 * xmlBeanDefinitionReaderSuch post-processors can, for example, register further entity
	 ...
	 * xmlBeanDefinitionReaderIt is a not required to specify a LoadTimeWeaver: Most providers will be
	 ...
	 * on it.
	 * xmlBeanDefinitionReader<b>NOTE:</b> As of Spring 2.5, the context's default LoadTimeWeaver (defined
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> Only applied if no external PersistenceUnitManager specified.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation reads in all persistence unit infos from
	 ...
	 * xmlBeanDefinitionReaderThe default implementation is empty.
