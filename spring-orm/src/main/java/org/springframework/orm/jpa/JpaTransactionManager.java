 ...
 *
 * xmlBeanDefinitionReaderThis transaction manager also supports direct DataSource access within a
...
public class JpaTransactionManager extends AbstractPlatformTransactionManager
	 ...
	 * xmlBeanDefinitionReaderAn EntityManagerFactory has to be set to be able to use it.
	 * @see #setEntityManagerFactory
	 */
	 ...
	 * xmlBeanDefinitionReaderAlternatively, specify the persistence unit name of the target EntityManagerFactory.
	 ...
	 * xmlBeanDefinitionReaderThis is an alternative to specifying the EntityManagerFactory by direct reference,
	 ...
	 * xmlBeanDefinitionReaderCan be populated with a String "value" (parsed via PropertiesEditor)
	 ...
	 * {@code EntityManagerFactory.createEntityManager(Map)} (if any).
	 * xmlBeanDefinitionReaderCan be populated with a "map" or "props" element in XML bean definitions.
	 * @see javax.persistence.EntityManagerFactory#createEntityManager(java.util.Map)
	 */
	 ...
	 * xmlBeanDefinitionReaderUseful for specifying entries directly, for example via "jpaPropertyMap[myKey]".
	 */
	 ...
	 * xmlBeanDefinitionReaderIf the EntityManagerFactory uses a known DataSource as its connection factory,
	 ...
	 * xmlBeanDefinitionReaderNote that you need to use a JPA dialect for a specific JPA implementation
	 ...
	 * xmlBeanDefinitionReaderIf the EntityManagerFactory uses a known JpaDialect, it will be autodetected:
	 * You can still explicitly specify the DataSource, but you don't need to in this case.
	 * xmlBeanDefinitionReaderThe dialect object can be used to retrieve the underlying JDBC connection
	 ...
	 * xmlBeanDefinitionReaderThe default implementation checks whether the EntityManagerFactory
