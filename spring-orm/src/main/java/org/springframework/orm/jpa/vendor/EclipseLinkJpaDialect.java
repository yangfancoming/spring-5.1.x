 ...
 *
 * xmlBeanDefinitionReaderBy default, this class acquires an early EclipseLink transaction with an early
...
public class EclipseLinkJpaDialect extends DefaultJpaDialect {
	 ...
	 * xmlBeanDefinitionReaderBy default, read-only transactions are started lazily but regular
	 ...
	 * xmlBeanDefinitionReaderSwitch this flag to "true" to enforce a lazy database transaction begin
