 ...
 *
 * xmlBeanDefinitionReaderThis implementation is largely a JavaBean, offering mutators
...
public class MutablePersistenceUnitInfo implements SmartPersistenceUnitInfo {
	 ...
	 * xmlBeanDefinitionReaderNote: This refers to annotated {@code package-info.java} files. It does
