 ...
 *
 * xmlBeanDefinitionReaderExposes Hibernate's persistence provider and EntityManager extension interface,
 ...
 *
 * xmlBeanDefinitionReader<b>A note about {@code HibernateJpaVendorAdapter} vs native Hibernate settings:</b>
...
public class HibernateJpaVendorAdapter extends AbstractJpaVendorAdapter {
	 ...
	 * JDBC Connection.
	 * xmlBeanDefinitionReaderSee {@link HibernateJpaDialect#setPrepareConnection(boolean)} for details.
	 * This is just a convenience flag passed through to {@code HibernateJpaDialect}.
	 * xmlBeanDefinitionReaderOn Hibernate 5.1/5.2, this flag remains {@code true} by default like against
	 ...
	 * xmlBeanDefinitionReader<b>NOTE: For a persistence unit with transaction type JTA e.g. on WebLogic,
