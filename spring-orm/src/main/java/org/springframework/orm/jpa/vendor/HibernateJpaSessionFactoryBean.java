 ...
 *
 * xmlBeanDefinitionReaderPrimarily available for resolving a SessionFactory by JPA persistence unit name
 * via the {@link #setPersistenceUnitName "persistenceUnitName"} bean property.
 *
 * xmlBeanDefinitionReaderNote that, for straightforward cases, you could also simply declare a factory method:
 *
 * <pre class="code">
 * &lt;bean id="sessionFactory" factory-bean="entityManagerFactory" factory-method="getSessionFactory"/&gt;
 * </pre>
 *
 * xmlBeanDefinitionReaderAnd as of JPA 2.1, {@link EntityManagerFactory#unwrap} provides a nice approach as well,
