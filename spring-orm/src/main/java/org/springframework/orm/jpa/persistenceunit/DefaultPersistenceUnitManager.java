 ...
 *
 * xmlBeanDefinitionReaderSupports standard JPA scanning for {@code persistence.xml} files,
 * with configurable file locations, JDBC DataSource lookup and load-time weaving.
 *
 * xmlBeanDefinitionReaderThe default XML file location is {@code classpath*:META-INF/persistence.xml},
...
public class DefaultPersistenceUnitManager
	 ...
	 * xmlBeanDefinitionReaderDefault is "classpath*:META-INF/persistence.xml".
	 */
	 ...
	 * xmlBeanDefinitionReaderDefault is "classpath:", that is, the root of the current classpath
	 ...
	 * xmlBeanDefinitionReaderPrimarily applied to a scanned persistence unit without {@code persistence.xml}.
	 ...
	 * xmlBeanDefinitionReaderDefault is none. Specify packages to search for autodetection of your entity
	 * classes in the classpath. This is analogous to Spring's component-scan feature
	 * ({@link org.springframework.context.annotation.ClassPathBeanDefinitionScanner}).
	 * xmlBeanDefinitionReaderSuch package scanning defines a "default persistence unit" in Spring, which
	 ...
	 * it's simply "default".
	 * xmlBeanDefinitionReader<b>Note: There may be limitations in comparison to regular JPA scanning.</b>
	 ...
	 * xmlBeanDefinitionReaderIf no explicit {@link #setMappingResources mapping resources} have been
	 ...
	 * xmlBeanDefinitionReaderNote that mapping resources must be relative to the classpath root,
	 ...
	 * xmlBeanDefinitionReaderIf no explicit mapping resources have been specified next to
	 * {@link #setPackagesToScan packages to scan}, this manager looks for a default
	 * {@code META-INF/orm.xml} file in the classpath, registering it as a mapping
	 * resource for the default unit if the mapping file is not co-located with a
	 * {@code persistence.xml} file (in which case we assume it is only meant to be
	 * used with the persistence units defined there, like in standard JPA).
	 * xmlBeanDefinitionReaderNote that specifying an empty array/list here suppresses the default
	 ...
	 * xmlBeanDefinitionReaderThe specified Map needs to define data source names for specific DataSource
	 ...
	 * xmlBeanDefinitionReaderDefault is JndiDataSourceLookup, which resolves DataSource names as
	 ...
	 * xmlBeanDefinitionReaderAlternatively, consider passing in a map from names to DataSource instances
	 ...
	 * xmlBeanDefinitionReaderIn JPA speak, a DataSource passed in here will be uses as "nonJtaDataSource"
	 ...
	 * xmlBeanDefinitionReaderIn JPA speak, a DataSource passed in here will be uses as "jtaDataSource"
	 * on the PersistenceUnitInfo passed to the PersistenceProvider, provided that
	 * none has been registered before.
	 ...
	 * xmlBeanDefinitionReaderSuch post-processors can, for example, register further entity classes and
	 ...
	 * xmlBeanDefinitionReaderIt is not required to specify a LoadTimeWeaver: Most providers will be able
	 ...
	 * xmlBeanDefinitionReaderIn terms of Spring-provided weaving options, the most important ones are
	 ...
	 * xmlBeanDefinitionReaderPersistenceUnitInfos cannot be obtained before this preparation
	 ...
	 * xmlBeanDefinitionReaderChecks whether a "META-INF/orm.xml" file exists in the classpath and uses it
	 ...
	 * xmlBeanDefinitionReaderThis can be used in {@link #postProcessPersistenceUnitInfo} implementations,
	 ...
	 * xmlBeanDefinitionReaderThe default implementation delegates to all registered PersistenceUnitPostProcessors.
	 ...
	 * xmlBeanDefinitionReaderDefault is {@code false}. May be overridden to return {@code true},
