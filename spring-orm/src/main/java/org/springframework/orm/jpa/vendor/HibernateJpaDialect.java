...
public class HibernateJpaDialect extends DefaultJpaDialect {
	 ...
	 * JDBC Connection.
	 * xmlBeanDefinitionReaderDefault is "true". If you turn this flag off, JPA transaction management
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> The default behavior in terms of read-only handling changed
