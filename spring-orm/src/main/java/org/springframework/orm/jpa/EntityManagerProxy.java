 ...
 *
 * xmlBeanDefinitionReaderThis interface is mainly intended for framework usage. Application code
...
public interface EntityManagerProxy extends EntityManager {
	 ...
	 * xmlBeanDefinitionReaderIn case of an extended EntityManager, this will be the associated
	 * raw EntityManager.
	 * xmlBeanDefinitionReaderIn case of a shared ("transactional") EntityManager, this will be
