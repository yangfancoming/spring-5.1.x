...
public abstract class AbstractJpaVendorAdapter implements JpaVendorAdapter {
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> This setting will override your JPA provider's default algorithm.
	 ...
	 * xmlBeanDefinitionReaderNote that the exact semantics of this flag depend on the underlying
	 * persistence provider. For any more advanced needs, specify the appropriate
	 * vendor-specific settings as "jpaProperties".
	 * xmlBeanDefinitionReader<b>NOTE: Do not set this flag to 'true' while also setting JPA 2.1's
	 ...
	 * xmlBeanDefinitionReaderFor more specific logging configuration, specify the appropriate
	 * vendor-specific settings as "jpaProperties".
	 * @see org.springframework.orm.jpa.AbstractEntityManagerFactoryBean#setJpaProperties
	 */
