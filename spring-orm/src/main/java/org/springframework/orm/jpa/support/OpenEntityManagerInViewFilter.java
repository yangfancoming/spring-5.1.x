 ...
 *
 * xmlBeanDefinitionReaderThis filter makes JPA EntityManagers available via the current thread,
 * which will be autodetected by transaction managers. It is suitable for service
 * layer transactions via {@link org.springframework.orm.jpa.JpaTransactionManager}
 * or {@link org.springframework.transaction.jta.JtaTransactionManager} as well
 * as for non-transactional read-only execution.
 *
 * xmlBeanDefinitionReaderLooks up the EntityManagerFactory in Spring's root web application context.
...
public class OpenEntityManagerInViewFilter extends OncePerRequestFilter {
	 ...
	 * xmlBeanDefinitionReaderDefault is "entityManagerFactory". Note that this default only applies
	 ...
	 * xmlBeanDefinitionReaderThis is an alternative to specifying the EntityManagerFactory by bean name,
	 ...
	 * xmlBeanDefinitionReaderThe default implementation delegates to the {@code lookupEntityManagerFactory}
	 ...
	 * xmlBeanDefinitionReaderCan be overridden in subclasses.
