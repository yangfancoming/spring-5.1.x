 ...
 *
 * xmlBeanDefinitionReaderThis post-processor will inject sub-interfaces of {@code EntityManagerFactory}
 ...
 *
 * xmlBeanDefinitionReaderNote: In the present implementation, PersistenceAnnotationBeanPostProcessor
 ...
 *
 * xmlBeanDefinitionReaderThis post-processor can either obtain EntityManagerFactory beans defined
 ...
 *
 * xmlBeanDefinitionReaderIf you prefer the Java EE server's own EntityManager handling, specify entries
 ...
 *
 * xmlBeanDefinitionReader<b>NOTE: In general, do not inject EXTENDED EntityManagers into STATELESS beans,
 ...
 *
 * xmlBeanDefinitionReaderNote: A default PersistenceAnnotationBeanPostProcessor will be registered
...
public class PersistenceAnnotationBeanPostProcessor
	 ...
	 * xmlBeanDefinitionReaderJNDI names specified here should refer to {@code persistence-unit-ref}
	 * entries in the Java EE deployment descriptor, matching the target persistence unit.
	 * xmlBeanDefinitionReaderIn case of no unit name specified in the annotation, the specified value
	 ...
	 * xmlBeanDefinitionReaderThis is mainly intended for use in a Java EE environment, with all lookup
	 ...
	 * xmlBeanDefinitionReaderIf no corresponding "persistenceContexts"/"extendedPersistenceContexts"
	 ...
	 * xmlBeanDefinitionReaderJNDI names specified here should refer to {@code persistence-context-ref}
	 ...
	 * will be taken (by default, the value mapped to the empty String),
	 * or simply the single persistence unit if there is only one.
	 * xmlBeanDefinitionReaderThis is mainly intended for use in a Java EE environment, with all
	 ...
	 * xmlBeanDefinitionReaderThis is mainly intended for lookups in the application context,
	 ...
	 * xmlBeanDefinitionReaderDefault is to check for a single EntityManagerFactory bean
	 ...
	 * xmlBeanDefinitionReaderCalled for EntityManagerFactory and EntityManager lookup
