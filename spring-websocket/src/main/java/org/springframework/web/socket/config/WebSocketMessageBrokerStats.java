 ...
 *
 * xmlBeanDefinitionReaderBy default aggregated information is logged every 30 minutes at INFO level.
 * The frequency of logging can be changed via {@link #setLoggingPeriod(long)}.
 *
 * xmlBeanDefinitionReaderThis class is declared as a Spring bean by the above configuration with the
...
public class WebSocketMessageBrokerStats {
	 ...
	 * xmlBeanDefinitionReaderBy default this property is set to 30 minutes (30 * 60 * 1000).
	 */
