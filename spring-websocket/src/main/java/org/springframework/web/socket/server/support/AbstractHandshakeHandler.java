 ...
 *
 * xmlBeanDefinitionReaderPerforms initial validation of the WebSocket handshake request - possibly rejecting it
 ...
 *
 * xmlBeanDefinitionReaderIf the negotiation succeeds, the actual upgrade is delegated to a server-specific
...
public abstract class AbstractHandshakeHandler implements HandshakeHandler, Lifecycle {
	 ...
	 * xmlBeanDefinitionReaderNote that if the WebSocketHandler passed in at runtime is an instance of
	 ...
	 * xmlBeanDefinitionReaderAs of 4.1, the default implementation of this method filters the list to
	 ...
	 * xmlBeanDefinitionReaderSubclasses can provide custom logic for associating a user with a session,
