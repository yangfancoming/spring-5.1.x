...
public class SockJsServiceRegistration {
	 ...
	 * xmlBeanDefinitionReaderThe amount of time between HTTP requests should be relatively brief and will not
	 ...
	 * xmlBeanDefinitionReaderBy default {@code Jackson2SockJsMessageCodec} is used requiring the
