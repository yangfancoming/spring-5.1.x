 ...
 * </ul>
 *
 * xmlBeanDefinitionReaderWebSocket Extension HTTP headers may include parameters and follow
 * <a href="https://tools.ietf.org/html/rfc7230#section-3.2">RFC 7230 section 3.2</a></p>
 *
 * xmlBeanDefinitionReaderNote that the order of extensions in HTTP headers defines their order of execution,
...
public class WebSocketExtension {
	 ...
	 * xmlBeanDefinitionReaderThis method can be used to parse a "Sec-WebSocket-Extension" header.
