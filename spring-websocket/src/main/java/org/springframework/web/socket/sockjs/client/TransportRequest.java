 ...
 *
 * xmlBeanDefinitionReaderNote that a single request to connect via {@link SockJsClient} may result
...
public interface TransportRequest {
	 ...
	 * xmlBeanDefinitionReaderFor an {@link XhrTransport} this is the URL for receiving messages.
	 */
	URI getTransportUrl();
