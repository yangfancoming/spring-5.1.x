...
public class WebSocketStompClient extends StompClientSupport implements SmartLifecycle {
	...
	/**
	 * {@inheritDoc}
	 * xmlBeanDefinitionReaderAlso automatically sets the {@link #setDefaultHeartbeat defaultHeartbeat}
	 ...
	 * size per message.
	 * xmlBeanDefinitionReaderBy default this is set to 64 * 1024 (64K).
	 */
	 ...
	 * xmlBeanDefinitionReaderDefault is "true".
	 */
	 ...
	 * xmlBeanDefinitionReaderBy default this is Integer.MAX_VALUE meaning that the WebSocket client
