...
public class WebSocketTransportRegistration {
	 ...
	 * xmlBeanDefinitionReaderThe default value is 64K (i.e. 64 * 1024).
	 * xmlBeanDefinitionReader<strong>Note:</strong> This is not the same as the size of an
	 ...
	 * xmlBeanDefinitionReaderIn general WebSocket servers expect that messages to a single WebSocket
	 ...
	 * xmlBeanDefinitionReader<strong>NOTE</strong> that the session time limit is checked only
	 ...
	 * xmlBeanDefinitionReader<strong>NOTE</strong> that closing the session may not succeed in
	 ...
	 * xmlBeanDefinitionReaderThe default value is 10 seconds (i.e. 10 * 10000).
	 ...
	 * on Linux.
	 * xmlBeanDefinitionReaderThe default value is 512K (i.e. 512 * 1024).
	 ...
	 * xmlBeanDefinitionReaderThis handler is for WebSocket connections that use a sub-protocol.
	 ...
	 * xmlBeanDefinitionReaderBy default this is set to {@code 60,000} (1 minute).
