...
public abstract class AbstractSockJsSession implements SockJsSession {
	 ...
	 * xmlBeanDefinitionReaderServlet containers dn't expose a a client disconnected callback, see
	 ...
	 * xmlBeanDefinitionReaderWe make a best effort to identify such network failures, on a per-server
