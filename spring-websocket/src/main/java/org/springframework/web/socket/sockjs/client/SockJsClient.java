 ...
 *
 * xmlBeanDefinitionReaderImplements {@link Lifecycle} in order to propagate lifecycle events to
...
public class SockJsClient implements WebSocketClient, Lifecycle {
	 ...
	 * xmlBeanDefinitionReaderIf the list includes an {@link XhrTransport} (or more specifically an
	 ...
	 * xmlBeanDefinitionReaderBy default if this property is not set, all handshake headers are also
	 ...
	 * xmlBeanDefinitionReaderIf the list of transports provided to the constructor contained an
	 ...
	 * xmlBeanDefinitionReaderBy default {@link org.springframework.web.socket.sockjs.frame.Jackson2SockJsMessageCodec
	 ...
	 * xmlBeanDefinitionReaderBy default this is not configured in which case a fallback may take longer.
	 ...
	 * xmlBeanDefinitionReaderBy default this method returns {@code null}.
