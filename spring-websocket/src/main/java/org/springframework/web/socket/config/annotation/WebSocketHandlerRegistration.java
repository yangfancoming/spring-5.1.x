...
public interface WebSocketHandlerRegistration {
	 ...
	 *
	 * xmlBeanDefinitionReaderWhen SockJS is enabled and origins are restricted, transport types that do not
	 ...
	 *
	 * xmlBeanDefinitionReaderEach provided allowed origin must start by "http://", "https://" or be "*"
