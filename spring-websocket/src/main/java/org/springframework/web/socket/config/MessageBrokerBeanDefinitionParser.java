 ...
 *
 * xmlBeanDefinitionReaderRegisters a Spring MVC {@link org.springframework.web.servlet.HandlerMapping}
 * with order 1 to map HTTP WebSocket handshake requests from STOMP/WebSocket clients.
 *
 * xmlBeanDefinitionReaderRegisters the following {@link org.springframework.messaging.MessageChannel MessageChannels}:
 * <ul>
 ...
 * </ul>
 *
 * xmlBeanDefinitionReaderRegisters one of the following based on the selected message broker options:
 * <ul>
