 ...
 * This is a flexible alternative to {@link ClassPathXmlApplicationContext} and {@link FileSystemXmlApplicationContext},
 * to be configured via setters,with an eventual {@link #refresh()} call activating the context.
 *
 * In case of multiple configuration files, bean definitions in later files will override those defined in earlier files.
...
public class GenericXmlApplicationContext extends GenericApplicationContext {
	...
	/**
	 * Delegates the given environment to underlying {@link XmlBeanDefinitionReader}. Should be called before any call to {@code #load}.
	 */
	@Override
