...
public class MarshallingMessageConverter implements MessageConverter, InitializingBean {
	 ...
	 * xmlBeanDefinitionReaderIf the given {@link Marshaller} also implements the {@link Unmarshaller} interface,
	 * it is used for both marshalling and unmarshalling. Otherwise, an exception is thrown.
	 * xmlBeanDefinitionReaderNote that all {@link Marshaller} implementations in Spring also implement the
	 ...
	 * xmlBeanDefinitionReaderThe default is {@link MessageType#BYTES}, i.e. this converter marshals
