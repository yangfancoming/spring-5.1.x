 ...
 *
 * xmlBeanDefinitionReaderNot intended to be used directly.
...
public abstract class JmsAccessor implements InitializingBean {
	 ...
	 * Default is "false".
	 * xmlBeanDefinitionReaderNote that within a JTA transaction, the parameters passed to
	 ...
	 * xmlBeanDefinitionReaderSetting this flag to "true" will use a short local JMS transaction
	 ...
	 * xmlBeanDefinitionReaderIf you want to use vendor-specific extensions to the acknowledgment mode,
	 ...
	 * xmlBeanDefinitionReaderDefault is {@link Session#AUTO_ACKNOWLEDGE}.
	 * xmlBeanDefinitionReaderVendor-specific extensions to the acknowledgment mode can be set here as well.
	 * xmlBeanDefinitionReaderNote that inside an EJB, the parameters to the
	 ...
	 * equivalent.
	 * xmlBeanDefinitionReaderThe default implementation delegates to the
