 ...
 *
 * xmlBeanDefinitionReaderIt customizes Jackson's default properties with the following ones:
 * <ul>
 * <li>{@link MapperFeature#DEFAULT_VIEW_INCLUSION} is disabled</li>
 * <li>{@link DeserializationFeature#FAIL_ON_UNKNOWN_PROPERTIES} is disabled</li>
 * </ul>
 *
 * xmlBeanDefinitionReaderCompatible with Jackson 2.6 and higher, as of Spring 4.3.
 *
 * @author Mark Pollack
 * @author Dave Syer
...
public class MappingJackson2MessageConverter implements SmartMessageConverter, BeanClassLoaderAware {
	 ...
	 * xmlBeanDefinitionReaderThe default is {@link MessageType#BYTES}, i.e. this converter marshals to
	 ...
	 * xmlBeanDefinitionReaderWhen reading from a a text-based message, an encoding may have been
	 ...
	 * xmlBeanDefinitionReaderDefault is none. Setting this property is optional; if not set, UTF-8 will
	 ...
	 * xmlBeanDefinitionReaderDefault is none. <b>NOTE: This property needs to be set in order to allow
	 ...
	 * xmlBeanDefinitionReaderDefault is no custom mappings, i.e. transferring raw Java class names.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation throws an {@link IllegalArgumentException}.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation consults the configured type id mapping and
	 ...
	 * xmlBeanDefinitionReaderThe default implementation parses the configured type id property name
