...
public abstract class AbstractJmsListenerEndpoint implements JmsListenerEndpoint {
	 ...
	 * xmlBeanDefinitionReaderThe concurrency limits can be a "lower-upper" String, e.g. "5-10", or a simple
	 * upper limit String, e.g. "10" (the lower limit will be 1 in this case).
	 * xmlBeanDefinitionReaderThe underlying container may or may not support all features. For instance, it
	 ...
	 * xmlBeanDefinitionReaderAvailable to subclasses, for inclusion in their {@code toString()} result.
	 */
