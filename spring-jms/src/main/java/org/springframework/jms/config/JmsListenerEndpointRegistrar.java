...
public class JmsListenerEndpointRegistrar implements BeanFactoryAware, InitializingBean {
	 ...
	 * xmlBeanDefinitionReaderAlternatively, the bean name of the {@link JmsListenerContainerFactory} to use
	 ...
	 * xmlBeanDefinitionReaderThe {@code factory} may be {@code null} if the default factory has to be
