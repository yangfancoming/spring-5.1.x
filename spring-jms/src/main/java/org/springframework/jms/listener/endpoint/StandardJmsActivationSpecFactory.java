 ...
 *
 * xmlBeanDefinitionReaderThe 'activationSpecClass' property is required, explicitly defining
 * the fully-qualified class name of the provider's ActivationSpec class
 * (e.g. "org.apache.activemq.ra.ActiveMQActivationSpec").
 *
 * xmlBeanDefinitionReaderCheck out {@link DefaultJmsActivationSpecFactory} for an extended variant
...
public class StandardJmsActivationSpecFactory implements JmsActivationSpecFactory {
	 ...
	 * xmlBeanDefinitionReaderApplied to each ActivationSpec object before it gets populated with
	 ...
	 * xmlBeanDefinitionReaderNote that a DestinationResolver for use with this factory must be
	 ...
	 * xmlBeanDefinitionReaderThis implementation applies all standard JMS settings, but ignores
	 ...
	 * xmlBeanDefinitionReaderThis implementation applies the standard JCA 1.5 acknowledge modes
