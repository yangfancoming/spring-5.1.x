...
public abstract class AbstractAdaptableMessageListener
	 ...
	 * xmlBeanDefinitionReaderResponse destinations are only relevant for listener methods that return
	 * result objects, which will be wrapped in a response message and sent to a
	 * response destination.
	 * xmlBeanDefinitionReaderAlternatively, specify a "defaultResponseQueueName" or "defaultResponseTopicName",
	 ...
	 * "JMSReplyTo" field.
	 * xmlBeanDefinitionReaderAlternatively, specify a JMS Destination object as "defaultResponseDestination".
	 ...
	 * xmlBeanDefinitionReaderThe default resolver is a DynamicDestinationResolver. Specify a
	 ...
	 * xmlBeanDefinitionReaderThe default converter is a {@link SimpleMessageConverter}, which is able
	 ...
	 * xmlBeanDefinitionReaderDelegates the message to the target listener method, with appropriate
	 ...
	 * xmlBeanDefinitionReader<b>Note:</b> Does not support sending response messages based on
	 ...
	 * xmlBeanDefinitionReaderThis method only applies when used as standard JMS {@link MessageListener}.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation sets the response's correlation id
	 ...
	 * xmlBeanDefinitionReaderThe default implementation first checks the JMS Reply-To
