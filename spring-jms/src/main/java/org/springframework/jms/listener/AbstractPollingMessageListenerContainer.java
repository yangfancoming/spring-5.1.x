 ...
 *
 * xmlBeanDefinitionReaderThis listener container variant is built for repeated polling attempts,
 ...
 *
 * xmlBeanDefinitionReaderThe underlying mechanism is based on standard JMS MessageConsumer handling,
 ...
 *
 * xmlBeanDefinitionReaderThis base class does not assume any specific mechanism for asynchronous
...
public abstract class AbstractPollingMessageListenerContainer extends AbstractMessageListenerContainer {
	 ...
	 * xmlBeanDefinitionReaderDefault is none, not performing any transactional wrapping.
	 ...
	 * xmlBeanDefinitionReader<b>Note: Consider the use of local JMS transactions instead.</b>
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> This value needs to be smaller than the transaction
