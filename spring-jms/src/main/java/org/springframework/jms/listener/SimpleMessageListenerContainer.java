 ...
 *
 * xmlBeanDefinitionReaderThis is the simplest form of a message listener container.
 ...
 *
 * xmlBeanDefinitionReaderSee the {@link AbstractMessageListenerContainer} javadoc for details
 ...
 *
 * xmlBeanDefinitionReaderFor a different style of MessageListener handling, through looped
...
public class SimpleMessageListenerContainer extends AbstractMessageListenerContainer implements ExceptionListener {
	 ...
	 * xmlBeanDefinitionReaderDefault is "false": connecting early, i.e. during the bean initialization phase.
	 ...
	 * xmlBeanDefinitionReaderDefault is "true": refreshing the shared connection and re-initializing the
	 ...
	 * xmlBeanDefinitionReaderThis listener container will always hold on to the maximum number of
	 * consumers {@link #setConcurrentConsumers} since it is unable to scale.
	 * xmlBeanDefinitionReaderThis property is primarily supported for configuration compatibility with
	 ...
	 * xmlBeanDefinitionReader<b>Do not raise the number of concurrent consumers for a topic.</b>
	 ...
	 * xmlBeanDefinitionReaderDefault is none, that is, to run in the JMS provider's own receive thread,
	 * blocking the provider's receive endpoint while executing the listener.
	 * xmlBeanDefinitionReaderSpecify a TaskExecutor for executing the listener in a different thread,
	 ...
	 * xmlBeanDefinitionReader<b>NOTE: Specifying a TaskExecutor for listener execution affects
	 ...
	 * xmlBeanDefinitionReader<b>NOTE: Concurrent listener execution via a TaskExecutor will lead
	 ...
	 * xmlBeanDefinitionReaderExecutes the listener, exposing the current JMS Session as
