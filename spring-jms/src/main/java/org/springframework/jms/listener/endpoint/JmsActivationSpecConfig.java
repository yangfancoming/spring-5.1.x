 ...
 *
 * xmlBeanDefinitionReaderTypically used in combination with {@link JmsMessageEndpointManager},
 * but not tied to it.
 *
...
public class JmsActivationSpecConfig {
	 ...
	 * xmlBeanDefinitionReaderNote that JCA resource adapters generally only support auto and dups-ok
	 ...
	 * xmlBeanDefinitionReaderJCA listener containers will always scale from zero to the given upper limit.
