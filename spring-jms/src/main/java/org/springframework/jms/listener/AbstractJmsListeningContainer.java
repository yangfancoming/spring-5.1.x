 ...
 *
 * xmlBeanDefinitionReaderThis class provides basic lifecycle management, in particular management
 ...
 *
 * xmlBeanDefinitionReaderThis base class does not assume any specific listener programming model
 ...
 *
 * xmlBeanDefinitionReaderFor a concrete listener programming model, check out the
...
public abstract class AbstractJmsListeningContainer extends JmsDestinationAccessor
	 ...
	 * by this container.
	 * xmlBeanDefinitionReaderNote that client IDs need to be unique among all active Connections
	 ...
	 * xmlBeanDefinitionReaderThe default implementation is empty. To be overridden in subclasses.
	 */
	 ...
	 * xmlBeanDefinitionReaderCreates a JMS Connection, starts the {@link javax.jms.Connection}
	 ...
	 * xmlBeanDefinitionReaderThis implementation always returns {@code true}; the default 'running'
	 * state is purely determined by {@link #start()} / {@link #stop()}.
	 * xmlBeanDefinitionReaderSubclasses may override this method to check against temporary
	 ...
	 * xmlBeanDefinitionReaderThe default implementation delegates to {@link #createSharedConnection()},
	 ...
	 * xmlBeanDefinitionReaderCalled on startup and also after an infrastructure exception
	 ...
	 * xmlBeanDefinitionReaderThe default implementation creates a standard Connection
	 ...
	 * xmlBeanDefinitionReaderThe default implementation sets the specified client id, if any.
	 ...
	 * has been restarted.
	 * xmlBeanDefinitionReaderIf this container has already been shut down, the task will not
	 ...
	 * xmlBeanDefinitionReaderTo be implemented by subclasses if they ever call
	 ...
	 * xmlBeanDefinitionReaderThe default implementation simply logs a corresponding message
	 * at debug level.
	 ...
	 * xmlBeanDefinitionReaderSubclasses need to implement this method for their specific
	 * invoker management process.
	 * xmlBeanDefinitionReaderA shared JMS Connection, if any, will already have been
	 ...
	 * xmlBeanDefinitionReaderSubclasses need to implement this method for their specific
	 * invoker management process.
	 * xmlBeanDefinitionReaderA shared JMS Connection, if any, will automatically be closed
	 * <i>afterwards</i>.
	 * @throws JMSException if shutdown failed
	 * @see #shutdown()
	 */
