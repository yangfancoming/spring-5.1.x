 ...
 *
 * xmlBeanDefinitionReaderAllows for defining a common {@link JmsActivationSpecConfig} object
 * that gets converted into a provider-specific JCA 1.5 ActivationSpec
 * object for activating the endpoint.
 *
 * xmlBeanDefinitionReader<b>NOTE:</b> This JCA-based endpoint manager supports standard JMS
...
public class JmsMessageEndpointManager extends GenericMessageEndpointManager
	 ...
	 * xmlBeanDefinitionReaderThis is a shortcut for configuring a dedicated JmsMessageEndpointFactory.
	 ...
	 * xmlBeanDefinitionReaderThe passed-in object may be a transaction manager which implements
	 ...
	 * xmlBeanDefinitionReaderIf no transaction manager is specified, the endpoint invocation
	 ...
	 * xmlBeanDefinitionReaderThis factory is dependent on the concrete JMS provider, e.g. on ActiveMQ.
	 ...
	 * xmlBeanDefinitionReaderIf not specified, destination names will simply be passed in as Strings.
	 * If specified, destination names will be resolved into Destination objects first.
	 * xmlBeanDefinitionReaderNote that a DestinationResolver is usually specified on the JmsActivationSpecFactory
	 ...
	 * xmlBeanDefinitionReaderThis config object will be turned into a concrete JCA 1.5 ActivationSpec
