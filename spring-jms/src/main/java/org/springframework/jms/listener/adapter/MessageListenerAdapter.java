 ...
 *
 * xmlBeanDefinitionReaderBy default, the content of incoming JMS messages gets extracted before
 ...
 * to {@code null}.)
 *
 * xmlBeanDefinitionReaderIf a target listener method returns a non-null object (typically of a
 ...
 * destination}).
 *
 * xmlBeanDefinitionReader<b>Note:</b> The sending of response messages is only available when
 ...
 *
 * xmlBeanDefinitionReaderFind below some examples of method signatures compliant with this
...
public class MessageListenerAdapter extends AbstractAdaptableMessageListener implements SubscriptionNameProvider {
	 ...
	 * xmlBeanDefinitionReaderIf no explicit delegate object has been specified, listener
	 ...
	 * xmlBeanDefinitionReaderThe default implementation simply returns the configured
	 ...
	 * xmlBeanDefinitionReaderThe default implementation builds an array with the given message object
	 ...
	 * xmlBeanDefinitionReaderThis can be overridden to treat special message content such as arrays
