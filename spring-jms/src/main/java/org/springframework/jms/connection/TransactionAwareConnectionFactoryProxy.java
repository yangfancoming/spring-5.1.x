 ...
 *
 * xmlBeanDefinitionReaderMessaging code which should remain unaware of Spring's JMS support can work with
 ...
 *
 * xmlBeanDefinitionReader<b>Make sure that TransactionAwareConnectionFactoryProxy is the outermost
 ...
 *
 * xmlBeanDefinitionReaderDelegates to {@link ConnectionFactoryUtils} for automatically participating
 ...
 *
 * xmlBeanDefinitionReaderNote that transactional JMS Sessions will be registered on a per-Connection
 ...
 *
 * xmlBeanDefinitionReaderReturned transactional Session proxies will implement the {@link SessionProxy}
 ...
 *
 * xmlBeanDefinitionReaderAs of Spring Framework 5, this class delegates JMS 2.0 {@code JMSContext}
...
public class TransactionAwareConnectionFactoryProxy
	 ...
	 * xmlBeanDefinitionReaderDefault is "false": If not within a managed transaction that encompasses
