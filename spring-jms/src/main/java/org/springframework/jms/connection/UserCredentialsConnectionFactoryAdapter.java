 ...
 *
 * xmlBeanDefinitionReaderCan be used to proxy a target JNDI ConnectionFactory that does not have user
 ...
 *
 * xmlBeanDefinitionReaderIn the following example, client code can simply transparently work
 ...
 * &lt;/bean></pre>
 *
 * xmlBeanDefinitionReaderIf the "username" is empty, this proxy will simply delegate to the standard
...
public class UserCredentialsConnectionFactoryAdapter
	 ...
	 * xmlBeanDefinitionReaderThis will override any statically specified user credentials,
