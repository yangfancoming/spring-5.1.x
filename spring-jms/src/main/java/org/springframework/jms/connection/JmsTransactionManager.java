 ...
 *
 * xmlBeanDefinitionReaderThis local strategy is an alternative to executing JMS operations within
 ...
 *
 * xmlBeanDefinitionReaderApplication code is required to retrieve the transactional JMS Session via
 ...
 *
 * xmlBeanDefinitionReaderAlternatively, you can allow application code to work with the standard
 ...
 *
 * xmlBeanDefinitionReader<b>The use of {@link CachingConnectionFactory} as a target for this
 ...
 *
 * xmlBeanDefinitionReaderThe use of a <i>raw</i> target ConnectionFactory would not only be inefficient
 ...
 *
 * xmlBeanDefinitionReaderTransaction synchronization is turned off by default, as this manager might
...
public class JmsTransactionManager extends AbstractPlatformTransactionManager
	 ...
	 * xmlBeanDefinitionReaderTurns off transaction synchronization by default, as this manager might
