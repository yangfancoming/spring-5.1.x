 ...
 *
 * xmlBeanDefinitionReaderYou can either pass in a specific JMS Connection directly or let this
 * factory lazily create a Connection via a given target ConnectionFactory.
 * This factory generally works with JMS 1.1 as well as the JMS 1.0.2 API.
 *
 * xmlBeanDefinitionReaderNote that when using the JMS 1.0.2 API, this ConnectionFactory will switch
 ...
 *
 * xmlBeanDefinitionReaderAs of Spring Framework 5, this class supports JMS 2.0 {@code JMSContext}
 ...
 *
 * xmlBeanDefinitionReaderUseful for testing and standalone environments in order to keep using the
 ...
 *
 * xmlBeanDefinitionReaderNote that Spring's message listener containers support the use of
...
public class SingleConnectionFactory implements ConnectionFactory, QueueConnectionFactory,
	 ...
	 * xmlBeanDefinitionReaderDefault is "false". Switch this to "true" to automatically trigger
	 * recovery based on your JMS provider's exception notifications.
	 * xmlBeanDefinitionReaderInternally, this will lead to a special JMS ExceptionListener
	 ...
	 * xmlBeanDefinitionReaderCloses and reinitializes the Connection if an underlying
	 ...
	 * xmlBeanDefinitionReaderAs this bean implements DisposableBean, a bean factory will
	 ...
	 * xmlBeanDefinitionReaderThe default implementation applies ExceptionListener and client id.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation always returns {@code null}.
