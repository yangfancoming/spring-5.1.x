 ...
 *
 * xmlBeanDefinitionReaderImplemented by {@link JmsTemplate}. Not often used but a useful option
 * to enhance testability, as it can easily be mocked or stubbed.
 *
 * xmlBeanDefinitionReaderProvides {@code JmsTemplate's} {@code send(..)} and
 ...
 *
 * xmlBeanDefinitionReaderProvides also basic request reply operation using a temporary
...
public interface JmsOperations {
	 ...
	 * xmlBeanDefinitionReaderThis will only work with a default destination specified!
	 ...
	 * xmlBeanDefinitionReaderThis method should be used carefully, since it will block the thread
