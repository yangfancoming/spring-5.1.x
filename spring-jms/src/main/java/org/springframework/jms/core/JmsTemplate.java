 ...
 *
 * xmlBeanDefinitionReaderIf you want to use dynamic destination creation, you must specify
 ...
 * domain.
 *
 * xmlBeanDefinitionReaderDefault settings for JMS Sessions are "not transacted" and "auto-acknowledge".
 ...
 *
 * xmlBeanDefinitionReaderThis template uses a
 ...
 *
 * xmlBeanDefinitionReader<b>NOTE: The {@code ConnectionFactory} used with this template should
...
public class JmsTemplate extends JmsDestinationAccessor implements JmsOperations {
	 ...
	 * xmlBeanDefinitionReaderNote: The ConnectionFactory has to be set before using the instance.
	 ...
	 * xmlBeanDefinitionReaderAlternatively, specify a "defaultDestinationName", to be
	 ...
	 * dynamically resolved via the DestinationResolver.
	 * xmlBeanDefinitionReaderAlternatively, specify a JMS Destination object as "defaultDestination".
	 * @see #send(MessageCreator)
	 * @see #convertAndSend(Object)
	 * @see #convertAndSend(Object, MessagePostProcessor)
	 * @see #setDestinationResolver
	 ...
	 * xmlBeanDefinitionReaderThe default converter is a SimpleMessageConverter, which is able
	 ...
	 * xmlBeanDefinitionReaderThis is only a hint to the JMS producer.
	 ...
	 * xmlBeanDefinitionReaderThe default is {@link #RECEIVE_TIMEOUT_INDEFINITE_WAIT}, which indicates
	 * a blocking receive without timeout.
	 * xmlBeanDefinitionReaderSpecify {@link #RECEIVE_TIMEOUT_NO_WAIT} (or any other negative value)
	 ...
	 * xmlBeanDefinitionReaderThe default is -1 (no delivery delay passed on to the broker).
	 ...
	 * xmlBeanDefinitionReaderDefault is "true" a.k.a. delivery mode "PERSISTENT".
	 * @see #setDeliveryMode(int)
	 ...
	 * xmlBeanDefinitionReaderSince a default value may be defined administratively,
	 ...
	 * xmlBeanDefinitionReaderUse {@code execute(SessionCallback)} for the general case.
	 ...
	 * xmlBeanDefinitionReaderReturn the response message or {@code null} if no message has
	 * @throws JMSException if thrown by JMS API methods
	 */
	@Nullable
	 ...
	 * xmlBeanDefinitionReaderThis implementation accepts any JMS 1.1 Connection.
	 ...
	 * xmlBeanDefinitionReaderThis implementation accepts any JMS 1.1 Session.
	 * @param holder the JmsResourceHolder
	 ...
	 * xmlBeanDefinitionReaderDelegates to {@link #doCreateProducer} for creation of the raw
	 * JMS MessageProducer.
