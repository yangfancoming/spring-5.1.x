 ...
 *
 * xmlBeanDefinitionReaderThanks to James Strachan for the original prototype that this
...
public class JmsInvokerClientInterceptor implements MethodInterceptor, InitializingBean {
	 ...
	 * xmlBeanDefinitionReaderThe specified name will be dynamically resolved via the
	 ...
	 * xmlBeanDefinitionReaderThe default resolver is a {@code DynamicDestinationResolver}. Specify a
	 ...
	 * xmlBeanDefinitionReaderDefault is a {@link DefaultRemoteInvocationFactory}.
	 * xmlBeanDefinitionReaderA custom invocation factory can add further context information
	 ...
	 * xmlBeanDefinitionReaderDefault is a {@link SimpleMessageConverter}, using a standard JMS
	 * {@link javax.jms.ObjectMessage} for each invocation / invocation result
	 * object.
	 * xmlBeanDefinitionReaderCustom implementations may generally adapt {@link java.io.Serializable}
	 ...
	 * (in milliseconds).
	 * xmlBeanDefinitionReaderThe default is 0, which indicates a blocking receive without timeout.
	 ...
	 * xmlBeanDefinitionReaderThe default implementation delegates to the {@link RemoteInvocationFactory}.
	 * xmlBeanDefinitionReaderCan be overridden in subclasses to provide custom {@code RemoteInvocation}
	 ...
	 * xmlBeanDefinitionReaderThe default implementation creates a JMS {@link javax.jms.ObjectMessage}
	 ...
	 * xmlBeanDefinitionReaderThe default implementation is based on standard JMS send/receive,
	 ...
	 * xmlBeanDefinitionReaderThe default implementation expects a JMS {@link javax.jms.ObjectMessage}
	 ...
	 * xmlBeanDefinitionReaderBy default, an {@link RemoteTimeoutException} is thrown. Sub-classes
	 ...
	 * xmlBeanDefinitionReaderThe default implementation throws a {@link MessageFormatException}.
	 ...
	 * object.
	 * xmlBeanDefinitionReaderThe default implementation calls the default {@code recreate()} method.
	 * xmlBeanDefinitionReaderCan be overridden in subclasses to provide custom recreation, potentially
