 ...
 *
 * xmlBeanDefinitionReaderNote that this class implements Spring's
...
public class JmsInvokerServiceExporter extends RemoteInvocationBasedExporter
	 ...
	 * xmlBeanDefinitionReaderDefault is a {@link org.springframework.jms.support.converter.SimpleMessageConverter},
	 * using a standard JMS {@link javax.jms.ObjectMessage} for each invocation /
	 * invocation result object.
	 * xmlBeanDefinitionReaderCustom implementations may generally adapt Serializables into
	 ...
	 * Default is "true".
	 * xmlBeanDefinitionReaderSwitch this flag to "false" to throw an exception back to the
	 ...
	 * xmlBeanDefinitionReaderThe default implementation creates a JMS ObjectMessage for the given
	 ...
	 * xmlBeanDefinitionReaderThe default implementation either discards the invalid message or
