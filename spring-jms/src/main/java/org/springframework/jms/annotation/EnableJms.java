 ...
 *
 * xmlBeanDefinitionReader{@code @EnableJms} enables detection of {@link JmsListener} annotations on any
 ...
 *
 * xmlBeanDefinitionReaderthe following configuration would ensure that every time a {@link javax.jms.Message}
 ...
 *
 * xmlBeanDefinitionReaderAnnotated methods can use flexible signature; in particular, it is possible to use
 ...
 *
 * xmlBeanDefinitionReaderWhen more control is desired, a {@code @Configuration} class may implement
