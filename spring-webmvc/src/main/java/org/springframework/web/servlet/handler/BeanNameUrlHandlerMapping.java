 ...
 * to a handler named "/foo", or to "/foo /foo2" in case of multiple mappings to a single handler.
 ...
 *
 * <p>Supports direct matches (given "/test" -> registered "/test") and "*" matches (given "/test" -> registered "/t*").
 *  Note that the default is to map within the current servlet mapping if applicable; see the
