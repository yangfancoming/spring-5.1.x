...
public class MvcUriComponentsBuilder {
	 ...
	 * <strong>Note:</strong> This method extracts values from "Forwarded"
	 ...
	 * <strong>Note:</strong> This method extracts values from "Forwarded" and "X-Forwarded-*" headers if found. See class-level docs.
	 ...
	 * processing a request or to apply a custom baseUrl not matching the current request.
	 * <strong>Note:</strong> This method extracts values from "Forwarded"
	 * and "X-Forwarded-*" headers if found. See class-level docs.
	 * @param baseUrl the builder for the base URL; the builder will be cloned and therefore not modified and may be re-used for further calls.
	 * @param controllerType the controller type
	 * @param method the controller method
	 * @param args argument values for the controller method
	 * @return a UriComponentsBuilder instance (never {@code null})
