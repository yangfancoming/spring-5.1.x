...
public final class PatternsRequestCondition extends AbstractRequestCondition<PatternsRequestCondition> {
	 ...
	 * <li>If there are patterns in both instances, combine the patterns in "this" with the patterns in "other" using {@link PathMatcher#combine(String, String)}.
	 ...
	 * that is guaranteed to contain matching patterns, sorted via {@link PathMatcher#getPatternComparator(String)}.
	 ...
	 * @return the same instance if the condition contains no patterns; or a new condition with sorted matching patterns; or {@code null} if no patterns match.
	 */
	@Override
	@Nullable
	 ...
	 * Invoking this method should yield results equivalent to those of calling {@link #getMatchingCondition(javax.servlet.http.HttpServletRequest)}.
	 * This method is provided as an alternative to be used if no request is available (e.g. introspection, tooling, etc).
	 ...
	 * Patterns are compared one at a time, from top to bottom via {@link PathMatcher#getPatternComparator(String)}.
	 * If all compared patterns match equally, but one instance has more patterns, it is  considered a closer match.
