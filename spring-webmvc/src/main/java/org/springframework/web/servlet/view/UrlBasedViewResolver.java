 ...
 *
 * <b>Note:</b> When chaining ViewResolvers, a UrlBasedViewResolver will check whether
...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	 ...
	 * <b>Redirect URLs can be specified via the "redirect:" prefix.</b>
	 ...
	 * Not possible in {@code loadView}, since overridden
	...
	protected View loadView(String viewName, Locale locale) throws Exception {
		...
		// 应用声明周期函数，也就是调用View对象的初始化函数和Spring用于切入bean创建的 Processor和Aware函数
	 ...
	 * Subclasses will typically call {@code super.buildView(viewName)}
