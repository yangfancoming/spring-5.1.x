 ...
 * Instantiated per document to parse: implementations can hold state in instance variables during the execution of the {@code registerBeanDefinitions} method ;
