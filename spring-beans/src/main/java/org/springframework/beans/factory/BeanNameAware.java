...
public interface BeanNameAware extends Aware {
	 ...
	 * in particular for inner bean  names, the actual bean name might have been made unique through appending
	 * "#..." suffixes. Use the {@link BeanFactoryUtils#originalBeanName(String)} method to extract the original bean name (without suffix), if desired.
	 */
