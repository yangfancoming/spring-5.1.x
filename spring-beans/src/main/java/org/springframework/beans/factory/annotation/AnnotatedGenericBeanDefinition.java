 ...
 * for example strategy implementations in Spring's component scanning support
 * (where the default definition class is {@link org.springframework.context.annotation.ScannedGenericBeanDefinition},which also implements the AnnotatedBeanDefinition interface).
 * @since 2.5
...
public class AnnotatedGenericBeanDefinition extends GenericBeanDefinition implements AnnotatedBeanDefinition {
	...
	// 组合模式，持有 AnnotationMetadata 和 MethodMetadata  接口
	...
	public AnnotatedGenericBeanDefinition(Class<?> beanClass) {
		...
		// 组合模式，持有 AnnotationMetadata 实现类
	 ...
	 * Note that this constructor is functionally equivalent to {@link org.springframework.context.annotation.ScannedGenericBeanDefinition ScannedGenericBeanDefinition},
