...
public class DependencyDescriptor extends InjectionPoint implements Serializable {
	 ...
	 * any variant of a parameter-level {@code Nullable} annotation (such as from JSR-305 or the FindBugs set of annotations),
	 * or a language-level nullable type declaration in Kotlin.
	 */
	 ...
	 * Subclasses may override this to select one of the instances or to opt out with no result at all through returning {@code null}.
	 * @param type the requested bean type
	 * @param matchingBeans a map of bean names and corresponding bean instances which have been pre-selected for the given type (qualifiers etc already applied)
	 ...
	 * instances which have been pre-selected for the given type (qualifiers etc already applied)
	 * @return a bean instance to proceed with, or {@code null} for none
	 * @throws BeansException in case of the not-unique scenario being fatal
	 * @since 4.3
