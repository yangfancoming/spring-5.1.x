...
/**
 * Interface used by the {@link DefaultBeanDefinitionDocumentReader} to handle custom, nested (directly under a {@code <bean>}) tags.
 * Decoration may also occur based on custom attributes applied to the
 * {@code <bean>} tag. Implementations are free to turn the metadata in the custom tag into as many
 * {@link org.springframework.beans.factory.config.BeanDefinition BeanDefinitions} as required and to transform the
 * {@link org.springframework.beans.factory.config.BeanDefinition} of the enclosing {@code <bean>} tag, potentially even returning a completely different
 ...
 * The parser locates a {@link BeanDefinitionDecorator} from the {@link NamespaceHandler} for the namespace in which the custom tag resides.
 * @since 2.0
...
public interface BeanDefinitionDecorator {
	 ...
	 * the supplied {@link org.springframework.beans.factory.config.BeanDefinition},returning the decorated definition.
