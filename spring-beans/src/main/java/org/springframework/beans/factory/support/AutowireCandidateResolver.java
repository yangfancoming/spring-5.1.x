...
public interface AutowireCandidateResolver {
	 ...
	 * The default implementation checks  {@link org.springframework.beans.factory.config.BeanDefinition#isAutowireCandidate()}.
	 ...
	 * @param descriptor the descriptor for the target method parameter or field
	 * @return whether the descriptor is marked as required or possibly indicating non-required status some other way (e.g. through a parameter annotation)
	 * @since 5.0
	 ...
	 * @return the lazy resolution proxy for the actual dependency target,or {@code null} if straight resolution is to be performed
	 * @since 4.0
	 */
	@Nullable
