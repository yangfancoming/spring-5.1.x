 ...
 *
 * This interface supports <b>nested properties</b> enabling the setting of properties on subproperties to an unlimited depth.
 *
...
public interface BeanWrapper extends ConfigurablePropertyAccessor {
	 ...
	 * @param propertyName the property to obtain the descriptor for (may be a nested path, but no indexed/mapped property)
