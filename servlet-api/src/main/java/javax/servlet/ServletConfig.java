 ...
 */
 public interface ServletConfig {
     ...
     * web application deployment descriptor, or for an unregistered (and thus  unnamed) servlet instance it will be the servlet's class name.
     ...
     * @return a <code>String</code> containing the value  of the initialization parameter, or <code>null</code> if  the initialization parameter does not exist
     */
