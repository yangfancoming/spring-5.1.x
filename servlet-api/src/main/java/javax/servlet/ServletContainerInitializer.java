 ...
 * application's startup phase and perform any required programmatic registration of servlets, filters, and listeners in response to it.
 ...
 * classes that implement, extend, or have been annotated with the class types specified by the annotation.
 ...
 * by the annotation, the container must pass a <tt>null</tt> Set of classes to {@link #onStartup}.
 ...
 * while at the same time providing a configuration option that would log them.
...
public interface ServletContainerInitializer {
     ...
     * is being started and in which the classes contained in <tt>c</tt> were found
