 ...
 * An expression can be evaluated standalone or in a specified context.
 * During expression evaluation the context may be asked to resolve references to types, beans, properties, and methods.
 * @since 3.0
 */
public class SpelExpression implements Expression {
	 ...
	 * been determined. If the compilation fails and has failed more than 100 times the expression is no longer considered suitable for compilation.
	 */
	 ...
	 * It also resets the compilation attempt failure count (an expression is normally no longer considered compilable if it cannot be compiled after 100 attempts).
	 */
	 ...
	 * This should ideally look like the input expression, but properly formatted since any unnecessary whitespace will have been discarded during the parse of the expression.
