...
/**
 * Strategy interface for creating JTA {@link javax.transaction.Transaction} objects based on specified transactional characteristics.
 * The default implementation, {@link SimpleTransactionFactory}, simply  wraps a standard JTA {@link javax.transaction.TransactionManager}.
 * This strategy interface allows for more sophisticated implementations  that adapt to vendor-specific JTA extensions.
 * @since 2.5
...
public interface TransactionFactory {
	 ...
	 * @throws NotSupportedException if the transaction manager does not support  a transaction of the specified type
	 ...
	 * Typically {@code false}. Checked by {@link org.springframework.jca.endpoint.AbstractMessageEndpointFactory}
