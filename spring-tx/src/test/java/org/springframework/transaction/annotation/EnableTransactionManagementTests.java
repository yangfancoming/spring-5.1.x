...
public class EnableTransactionManagementTests {
	...
	public void transactionProxyIsCreated() {
		...
		assertTrue(services.containsKey("testBean"));
		ctx.close();
	}
	...
	public void transactionProxyIsCreatedWithEnableOnExcludedSuperclass() {
		AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(ParentEnableTxConfig.class, ChildEnableTxConfig.class, TxManagerConfig.class);
		TransactionalTestBean bean = ctx.getBean(TransactionalTestBean.class);
