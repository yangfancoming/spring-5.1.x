 ...
 * This is a capability that standard {@code java.util.Properties} unfortunately lacked up until JDK 5:
 * You were only able to load files using the ISO-8859-1 charset there.
 *
 * Loading from and storing to a stream delegates to {@code Properties.load}
 ...
 * {@code Properties.load/store} will also be used for readers/writers,effectively turning this class into a plain backwards compatibility adapter.
 *
 ...
 * an encoding for a Reader/Writer (like ReloadableResourceBundleMessageSource's "defaultEncoding" and "fileEncodings" properties).
