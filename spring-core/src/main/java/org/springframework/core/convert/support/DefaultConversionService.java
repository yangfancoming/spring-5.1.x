 ...
 * {@link #addDefaultConverters(ConverterRegistry)} utility method for ad-hoc use against any {@code ConverterRegistry} instance.
 * @since 3.1
 */
public class DefaultConversionService extends GenericConversionService {
	 ...
	 * <b>NOTE:</b> We highly recommend constructing individual {@code ConversionService} instances for customization purposes.
	 * This accessor is only meant as a fallback for code paths which need simple type coercion but cannot access a longer-lived
