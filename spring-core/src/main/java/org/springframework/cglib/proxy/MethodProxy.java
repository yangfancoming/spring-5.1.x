 ...
 * be used to either invoke the original method, or call the same method on a different object of the same type.
...
public class MethodProxy {
	...
	private void init() {
		 ...
		 * code could allow fastClassInfo to be instantiated more than once, which appears to be benign.
		 */
	 ...
	 * @param obj the compatible object; recursion will result if you use the object passed as the first argument to the MethodInterceptor (usually not what you want)
	 * @param args the arguments passed to the intercepted method; you may substitute a different argument array as long as the types are compatible
	 * @throws Throwable the bare exceptions thrown by the called method are passed through  without wrapping in an <code>InvocationTargetException</code>
