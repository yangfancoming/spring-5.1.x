 ...
 *
 * xmlBeanDefinitionReader<b>This is the central convenience class for setting up a
 * CommonJ WorkManager in a Spring context.</b>
 *
 * xmlBeanDefinitionReaderAlso implements the CommonJ WorkManager interface itself, delegating all
 ...
 *
 * xmlBeanDefinitionReaderThe CommonJ WorkManager will usually be retrieved from the application
 * server's JNDI environment, as defined in the server's management console.
 *
 * xmlBeanDefinitionReaderNote: On the upcoming EE 7 compliant versions of WebLogic and WebSphere, a
...
public class WorkManagerTaskExecutor extends JndiLocatorSupport
	 ...
	 * xmlBeanDefinitionReaderAlternatively, you can also specify the JNDI name of the target WorkManager.
	 ...
	 * xmlBeanDefinitionReaderThis can either be a fully qualified JNDI name, or the JNDI name relative
	 ...
	 * xmlBeanDefinitionReaderThis shared WorkListener instance will be passed on to the
	 ...
	 * xmlBeanDefinitionReaderNote that such a decorator is not necessarily being applied to the
	 * user-supplied {@code Runnable}/{@code Callable} but rather to the actual
	 * execution callback (which may be a wrapper around the user-supplied task).
	 * xmlBeanDefinitionReaderThe primary use case is to set some execution context around the task's
