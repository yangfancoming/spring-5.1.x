...
public abstract class TimerManagerAccessor extends JndiLocatorSupport
	 ...
	 * xmlBeanDefinitionReaderNote that the given TimerManager's lifecycle will be managed
	 * by this FactoryBean.
	 * xmlBeanDefinitionReaderAlternatively (and typically), you can specify the JNDI name
	 ...
	 * xmlBeanDefinitionReaderDefault is "false", i.e. managing an independent TimerManager instance.
	 ...
	 * xmlBeanDefinitionReaderSwitch this flag to "true" if you are obtaining a shared TimerManager,
	 ...
	 * xmlBeanDefinitionReaderThe sole difference between this FactoryBean being in shared or
