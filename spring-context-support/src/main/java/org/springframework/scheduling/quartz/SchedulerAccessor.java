 ...
 *
 * xmlBeanDefinitionReaderFor concrete usage, check out the {@link SchedulerFactoryBean} and
...
public abstract class SchedulerAccessor implements ResourceLoaderAware {
	 ...
	 * xmlBeanDefinitionReaderThis is not necessary when a Trigger determines the JobDetail
	 ...
	 * xmlBeanDefinitionReaderIf the Trigger determines the corresponding JobDetail itself,
