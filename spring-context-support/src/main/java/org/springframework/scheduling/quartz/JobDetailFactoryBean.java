 ...
 *
 * xmlBeanDefinitionReader{@code JobDetail(Impl)} itself is already a JavaBean but lacks
...
public class JobDetailFactoryBean
	 ...
	 * xmlBeanDefinitionReaderThese objects will be available to this Job only,
	 ...
	 * xmlBeanDefinitionReader<b>Note: When using persistent job stores where JobDetail contents will
