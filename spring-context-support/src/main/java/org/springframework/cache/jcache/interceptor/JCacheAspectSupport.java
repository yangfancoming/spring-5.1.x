 ...
 *
 * xmlBeanDefinitionReaderUse the Spring caching abstraction for cache-related operations. No JSR-107
 * {@link javax.cache.Cache} or {@link javax.cache.CacheManager} are required to
 * process standard JSR-107 cache annotations.
 *
 * xmlBeanDefinitionReaderThe {@link JCacheOperationSource} is used for determining caching operations
 *
 * xmlBeanDefinitionReaderA cache aspect is serializable if its {@code JCacheOperationSource} is serializable.
 *
