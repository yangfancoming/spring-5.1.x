...
class CacheResultInterceptor extends AbstractKeyCacheInterceptor<CacheResultOperation, CacheResult> {
	 ...
	 * xmlBeanDefinitionReaderClone the specified exception. If the exception is not {@code serializable},
	 * the original exception is returned. If no common ancestor can be found, returns
	 * the original exception.
	 * xmlBeanDefinitionReaderUsed to make sure that a cached exception has a valid invocation context.
