 ...
 *
 * xmlBeanDefinitionReaderThe configuration of the underlying cache can be fine-tuned through a
 ...
 *
 * xmlBeanDefinitionReaderRequires Caffeine 2.1 or higher.
 *
 * @author Ben Manes
...
public class CaffeineCacheManager implements CacheManager {
	 ...
	 * xmlBeanDefinitionReaderThe number of caches and their names will be fixed after a call to this method,
	 * with no creation of further cache regions at runtime.
	 * xmlBeanDefinitionReaderCalling this with a {@code null} collection argument resets the
	 ...
	 * xmlBeanDefinitionReaderDefault is "true", despite Caffeine itself not supporting {@code null} values.
