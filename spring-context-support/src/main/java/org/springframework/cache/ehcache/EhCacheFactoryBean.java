 ...
 *
 * xmlBeanDefinitionReaderIf the specified named cache is not configured in the cache configuration descriptor,
 ...
 *
 * xmlBeanDefinitionReaderNote: If the named Cache instance is found, the properties will be ignored and the
 * Cache instance will be retrieved from the CacheManager.
 *
 * xmlBeanDefinitionReaderNote: As of Spring 5.0, Spring's EhCache support requires EhCache 2.10 or higher.
 *
...
public class EhCacheFactoryBean extends CacheConfiguration implements FactoryBean<Ehcache>, BeanNameAware, InitializingBean {
	 ...
	 * xmlBeanDefinitionReaderNote that in particular for persistent caches, it is advisable to
	 ...
	 * xmlBeanDefinitionReaderA separate EhCacheManagerFactoryBean is also necessary for loading
	 ...
	 * xmlBeanDefinitionReaderIf you intend to build a self-populating blocking cache,
	 ...
	 * xmlBeanDefinitionReaderThe specified factory can be of type
	 ...
	 * xmlBeanDefinitionReaderNote: Any such self-populating cache is automatically a blocking cache.
