 ...
 *
 * xmlBeanDefinitionReaderThese methods are a simple alternative to custom {@link CacheManager} setup
...
public abstract class EhCacheManagerUtils {
	 ...
	 * xmlBeanDefinitionReaderThe CacheManager will be configured from "ehcache.xml" in the root of the class path
