 ...
 *
 * xmlBeanDefinitionReaderIf no config location is specified, a CacheManager will be configured from
 ...
 *
 * xmlBeanDefinitionReaderSetting up a separate EhCacheManagerFactoryBean is also advisable when using
...
public class EhCacheManagerFactoryBean implements FactoryBean<CacheManager>, InitializingBean, DisposableBean {
	 ...
	 * xmlBeanDefinitionReaderDefault is "ehcache.xml" in the root of the class path, or if not found,
	 ...
	 * xmlBeanDefinitionReaderTypically used in combination with {@link #setCacheManagerName "cacheManagerName"}
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> This feature allows for sharing this EhCacheManagerFactoryBean's
	 ...
	 * xmlBeanDefinitionReaderThis flag overrides {@link #setAcceptExisting "acceptExisting"} if both are set,
