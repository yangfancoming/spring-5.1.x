 ...
 *
 * xmlBeanDefinitionReaderThe optional "configLocation" property sets the location of a FreeMarker
 ...
 *
 * xmlBeanDefinitionReaderThe "freemarkerVariables" property can be used to specify a Map of
 ...
 *
 * xmlBeanDefinitionReaderThe simplest way to use this class is to specify a "templateLoaderPath";
...
public class FreeMarkerConfigurationFactory {
	 ...
	 * xmlBeanDefinitionReaderUsed for template rendering unless there is an explicit encoding specified
	 ...
	 * xmlBeanDefinitionReaderThe {@link TemplateLoader TemplateLoaders} specified here will be
	 ...
	 * xmlBeanDefinitionReaderWhen populated via a String, standard URLs like "file:" and "classpath:"
	 * pseudo URLs are supported, as understood by ResourceEditor. Allows for
	 * relative paths when running in an ApplicationContext.
	 * xmlBeanDefinitionReaderWill define a path for the default FreeMarker template loader.
	 ...
	 * xmlBeanDefinitionReaderTo enforce the use of SpringTemplateLoader, i.e. to not resolve a path
	 * as file system resource in any case, turn off the "preferFileSystemAccess"
	 * flag. See the latter's javadoc for details.
	 * xmlBeanDefinitionReaderIf you wish to specify your own list of TemplateLoaders, do not set this
	 ...
	 * xmlBeanDefinitionReaderIf this is enabled, FreeMarkerConfigurationFactory will try to resolve
	 ...
	 * xmlBeanDefinitionReaderDefault is "true". Turn this off to always load via SpringTemplateLoader
	 ...
	 * xmlBeanDefinitionReaderCalled by {@code createConfiguration()}.
	 ...
	 * xmlBeanDefinitionReaderDefault implementation creates either a FileTemplateLoader or
	 ...
	 * template loaders.
	 * xmlBeanDefinitionReaderCalled by {@code createConfiguration()}. Note that specified
