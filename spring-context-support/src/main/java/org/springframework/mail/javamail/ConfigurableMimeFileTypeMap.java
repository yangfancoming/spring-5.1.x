 ...
 *
 * xmlBeanDefinitionReaderThe mapping file should be in the following format, as specified by the
 ...
 *
 * xmlBeanDefinitionReaderBy default, the mappings in the {@code mime.types} file located in the
 ...
 *
 * xmlBeanDefinitionReaderAdditional mappings can be added via the {@code mappings} bean property,
...
public class ConfigurableMimeFileTypeMap extends FileTypeMap implements InitializingBean {
	 ...
	 * xmlBeanDefinitionReaderNeeds to follow the {@code mime.types} file format, as specified
	 ...
	 * xmlBeanDefinitionReaderThe default implementation creates an Activation Framework {@link MimetypesFileTypeMap},
