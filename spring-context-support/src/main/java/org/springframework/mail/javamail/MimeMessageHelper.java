 ...
 *
 * xmlBeanDefinitionReaderMirrors the simple setters of {@link org.springframework.mail.SimpleMailMessage},
 ...
 *
 * xmlBeanDefinitionReaderOffers support for HTML text content, inline elements such as images, and typical
 ...
 *
 * xmlBeanDefinitionReaderTypically used in {@link MimeMessagePreparator} implementations or
 ...
 *
 * xmlBeanDefinitionReaderSample code for an HTML mail with an inline image and a PDF attachment:
 *
 * <pre class="code">
 ...
 *
 * xmlBeanDefinitionReader<b>Warning regarding multipart mails:</b> Simple MIME messages that
...
public class MimeMessageHelper {
	 ...
	 * xmlBeanDefinitionReaderThis was Spring 1.0's default behavior. It is known to work properly
	 ...
	 * will all get added to that root element.
	 * xmlBeanDefinitionReaderThis was the default behavior from Spring 1.1 up to 1.2 final.
	 ...
	 * xmlBeanDefinitionReaderThis is the default since Spring 1.2.1. This is arguably the most correct
	 ...
	 * xmlBeanDefinitionReaderThe character encoding for the message will be taken from
	 ...
	 * xmlBeanDefinitionReaderConsider using the MimeMessageHelper constructor that
	 ...
	 * on the other hand.
	 * xmlBeanDefinitionReaderTexts and inline elements can either be stored in the root element
	 ...
	 * xmlBeanDefinitionReaderBy default, the root MimeMultipart element will be of type "mixed"
	 ...
	 * xmlBeanDefinitionReaderThis will be the direct content of the MimeMessage,
	 ...
	 * xmlBeanDefinitionReaderThis will be nested within the root MimeMultipart,
	 * in case of a multipart mail.
	 * @throws IllegalStateException if this helper is not in multipart mode
	 * @see #isMultipart
	 ...
	 * xmlBeanDefinitionReaderDefault is the {@code FileTypeMap} that the underlying
	 ...
	 * Default is "false".
	 * xmlBeanDefinitionReaderNote that this is by default just available for JavaMail >= 1.3.
	 ...
	 * xmlBeanDefinitionReaderDefault implementation invokes {@code InternetAddress.validate()},
	 * provided that address validation is activated for the helper instance.
	 * xmlBeanDefinitionReaderNote that this method will just work on JavaMail >= 1.3. You can override
	 ...
	 * xmlBeanDefinitionReader<b>NOTE:</b> Invoke {@link #addInline} <i>after</i> {@code setText};
	 ...
	 * xmlBeanDefinitionReaderNote that the InputStream returned by the DataSource implementation
	 * needs to be a <i>fresh one on each call</i>, as JavaMail will invoke
	 * {@code getInputStream()} multiple times.
	 * xmlBeanDefinitionReader<b>NOTE:</b> Invoke {@code addInline} <i>after</i> {@link #setText};
	 * else, mail readers might not be able to resolve inline references correctly.
	 ...
	 * Add an inline element to the MimeMessage, taking the content from a
	 * {@code java.io.File}.
	 * xmlBeanDefinitionReaderThe content type will be determined by the name of the given
	 ...
	 * content file. Do not use this for temporary files with arbitrary
	 * filenames (possibly ending in ".tmp" or the like)!
	 * xmlBeanDefinitionReaderNote that the InputStream returned by the Resource implementation
	 * needs to be a <i>fresh one on each call</i>, as JavaMail will invoke
	 * {@code getInputStream()} multiple times.
	 * xmlBeanDefinitionReader<b>NOTE:</b> Invoke {@code addInline} <i>after</i> {@link #setText};
	 * else, mail readers might not be able to resolve inline references correctly.
	 ...
	 * xmlBeanDefinitionReaderYou can determine the content type for any given filename via a Java
	 * Activation Framework's FileTypeMap, for example the one held by this helper.
	 * xmlBeanDefinitionReaderNote that the InputStream returned by the InputStreamSource implementation
	 * needs to be a <i>fresh one on each call</i>, as JavaMail will invoke
	 * {@code getInputStream()} multiple times.
	 * xmlBeanDefinitionReader<b>NOTE:</b> Invoke {@code addInline} <i>after</i> {@code setText};
	 * else, mail readers might not be able to resolve inline references correctly.
	 * @param contentId the content ID to use. Will end up as "Content-ID" header
	 * in the body part, surrounded by angle brackets: e.g. "myId" -> "&lt;myId&gt;".
	 * Can be referenced in HTML source via src="cid:myId" expressions.
	 ...
	 * xmlBeanDefinitionReaderThe content type will be determined by the given filename for
	 * the attachment. Thus, any content source will be fine, including
	 * temporary files with arbitrary filenames.
	 * xmlBeanDefinitionReaderNote that the InputStream returned by the InputStreamSource
