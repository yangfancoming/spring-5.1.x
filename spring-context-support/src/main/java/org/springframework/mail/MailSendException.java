...
public class MailSendException extends MailException {
	 ...
	 * xmlBeanDefinitionReaderThe messages should be the same that were originally passed
	 ...
	 * as values.
	 * xmlBeanDefinitionReaderNote that a general mail server connection failure will not result
	 ...
	 * xmlBeanDefinitionReaderThe messages will be the same that were originally passed to the
	 * invoked send method, that is, SimpleMailMessages in case of using
	 * the generic MailSender interface.
	 * xmlBeanDefinitionReaderIn case of sending MimeMessage instances via JavaMailSender,
	 * the messages will be of type MimeMessage.
	 * xmlBeanDefinitionReader<b>NOTE:</b> This Map will not be available after serialization.
