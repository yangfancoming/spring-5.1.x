 ...
 * 用于将Web请求映射到具有灵活方法签名的请求处理类中的方法的注解
 *
 * <p>Both Spring MVC and Spring WebFlux support this annotation through a RequestMappingHandlerMapping and RequestMappingHandlerAdapter
 * in their respective modules and package structure.
 * For the exact list of supported handler method arguments and return types in each,
 * please use the reference documentation links below:
 *
 * <ul>
 * <li>Spring MVC
 ...
 * In most cases, at the method level applications will prefer to use one of the HTTP method specific variants
 ...
 * {@code @RequestMapping} and {@code @SessionAttributes} - on the controller <i>interface</i> rather than on the implementation class.
