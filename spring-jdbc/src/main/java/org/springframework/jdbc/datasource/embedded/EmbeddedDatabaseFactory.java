 ...
 * </ul>
 *
 * After configuring the factory, call {@link #getDatabase()} to obtain
...
public class EmbeddedDatabaseFactory {
	 ...
	 * Setting this flag to {@code true} overrides any explicit name set
	 ...
	 * Will be overridden if the {@code generateUniqueDatabaseName} flag
	 ...
	 * If the {@code generateUniqueDatabaseName} flag has been set to {@code true},
	 ...
	 * embedded database.
	 * Returns {@code null} if the {@code DataSource} has not been initialized
