 ...
 * @ Description: 测试 component-scan 的 value 属性 xml标签版 <context:component-scan>
 * @ author  山羊来了
...
public class App {
	...
	/**
	 * 传统标签 <component-scan> 可以扫描到 com.goat.chapter201.common 包下的
	 * 其中6个类中 3个没有注解 因此只有3个会被加载到spring的容器中
